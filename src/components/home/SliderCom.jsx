...
const SliderCom = () => {
  ...
  return (
    <div>
        <Slider {...settings}>
          <div className='!flex items-center justify-around bg-gray-100 px-6'>
            <div >
                <div className=' text-4xl font-bold'>New Season Sneakers are here!</div>
          ...
          <div className='!flex items-center justify-around bg-gray-100 px-6'>
            <div>
                <div className='text-4xl font-bold'>Live Your Style!</div>
